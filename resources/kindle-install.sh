ROUTER=`ip route show  | grep default | sed 's/default via //g' | sed 's/ dev wlan0 //g'`
BASE="http://${ROUTER}:10008"
...
# add the cronjob
echo "* * * * * /mnt/us/update.sh; sleep 30; /mnt/us/update.sh" > /etc/crontab/root
